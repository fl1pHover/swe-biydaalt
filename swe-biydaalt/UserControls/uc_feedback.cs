...
namespace swe_biydaalt.UserControls
{
    public partial class uc_feedback : UserControl
    {
        ...
        private void uc_feedback_Load(object sender, EventArgs e)
        {
            ...
            con.Open();
            string query = "select a.*, b.Username, b.Phone, c.Title from Feedbacks a inner join Users b on a.UserID = b.UserID inner join FeedbackTitle c on a.TitleID = c.TitleID where FbTypeID = '3'";
